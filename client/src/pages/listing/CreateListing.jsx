...
export default function CreateListing() {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios.post('/api/listing/create', formData)
            .then(res => {
                if (res.status == 201) {
        ...
        <main className='p-3 max-w-4xl mx-auto'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-4 sm:flex-row'>
                ...
                <div className='flex flex-col flex-1 gap-4'>
                    ...
                    <button className='p-3 my-2 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80' type='submit' disabled={creating || uploading}>{creating ? 'creating...' : 'create listing'}</button>
